    ...
    <>
      ...
      <span className="relative min-h-[1lh]">
        ...
        <Combobox
          ...
          ref={ref}
          className={cn(
            "absolute top-0 left-0 size-full scroll-auto bg-transparent outline-none",
            className
          )}
          value={value}
          autoSelect
  ...
  return (
    <Portal>
      <ComboboxPopover
        ...
        className={cn(
          "bg-popover absolute z-500 max-h-[288px] min-w-[300px] overflow-y-auto rounded-md shadow-md",
          className
        )}
        {...props}
      />
